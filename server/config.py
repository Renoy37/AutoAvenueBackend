...
app = Flask(__name__)
# CORS(app)
CORS(app, resources={r"/api/*": {"origins": ["http://localhost:5173", "https://autoavenuebackend.onrender.com", "http://127.0.0.1:5555"], "methods": ["GET", "PUT", "POST", "DELETE", "OPTIONS"], "allow_headers": ["Content-Type", "Authorization"]}})
